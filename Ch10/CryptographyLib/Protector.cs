...
namespace Packt.Shared
{
    ...
    {
        //salt size must at least 8 bytes, here use 16 bytes
        ...
        public static string Encrypt(string plainText, string password){
            ...
            aes.Key=pbkdf2.GetBytes(32); //32-bytes 256-bit key
            aes.IV=pbkdf2.GetBytes(16); //16-bytes 128-bit IV
        ...
        public static User Register(string username,string password, string[] roles = null){
            ...
            var saltedhashedPassword=SaltedAndHashPassword(password,saltText);
            var user=new User{
        ...
        public static bool CheckPassword(string username,string password){
            ...
            var saltedhashedPassword=SaltedAndHashPassword(password,user.Salt);
            return (saltedhashedPassword == user.SaltedhashedPassword);
        }

        private static string SaltedAndHashPassword(string password,string salt){
